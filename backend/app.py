...
from routes.dashboard_audit_routes import bp as dashboard_audit_bp
from routes.ae_commissions_routes import bp as ae_commissions_bp
...
def create_app() -> Flask:
    ...
    app.register_blueprint(ae_commissions_bp)
