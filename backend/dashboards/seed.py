...
RESET_CHART_KEYS = {
    "main": [
        ...
        "sa_kpi_reactivated_clients_30d",
        "sa_table_reactivated_clients_30d_detail",
        ...
        "op_select_rejection_recruiters",
        "op_select_churn_recruiters",
        "op_select_rejection_accounts",
        "op_select_churn_accounts",
        "op_select_rejection_reasons",
        "op_select_churn_reasons",
        "op_donut_close_lost_reasons",
        "op_table_close_lost_reasons_detail",
        "op_select_close_lost_accounts",
        "op_select_close_lost_reasons",
        "op_select_close_lost_recruiters",
        "op_kpi_one_shot_kill",
        "op_table_one_shot_kill_by_recruiter",
        "op_line_one_shot_kill",
        "op_table_one_shot_kill_detail",
...
MAIN_CHARTS = [
    ...
    {
        "chart_key": "sa_kpi_reactivated_clients_30d",
        "tab_key": "sales",
        "title": "Clientes reactivados en la ventana",
        "type": "kpi",
        "dataset_key": "reactivated_clients_30d_total",
        "config": {"mapping": {"value": "reactivated_clients_30d", "formatter": "number"}},
        "position": {"x": 0, "y": 30, "w": 6, "h": 5},
        "sort_order": 121,
    },
    {
        "chart_key": "sa_table_reactivated_clients_30d_detail",
        "tab_key": "sales",
        "title": "Detalle - Reactivados",
        "type": "table",
        "dataset_key": "reactivated_clients_30d_detail",
        "config": {
            "mapping": {
                "columns": [
                    "start_date",
    ...
    {
        "chart_key": "op_donut_churn_reasons_m3",
        "tab_key": "operations",
        "title": "Operations · Razones de caída — churn M3",
        "type": "donut",
        "dataset_key": "op_churn_reasons_m3",
        "config": {"mapping": {"x": "reason", "y": ["count"], "formatter": "number"}},
        "position": {"x": 0, "y": 125, "w": 6, "h": 6},
        "sort_order": 299.75,
    },
    {
        "chart_key": "op_table_churn_reasons_m3_detail",
        "tab_key": "operations",
        "title": "Operations · detalle caídas churn M3 por razón",
        "type": "table",
        "dataset_key": "op_churn_reasons_m3_detail",
        "config": {"mapping": {"columns": ["reason", "candidate_name", "client_name", "opp_position_name", "inactive_date"]}},
        "position": {"x": 6, "y": 125, "w": 6, "h": 6},
        "sort_order": 299.76,
    },
    {
        "chart_key": "op_select_churn_m3_reasons",
        "tab_key": "operations",
        "title": "Operations · razones de caída churn M3 (filtro)",
        "type": "table",
        "dataset_key": "op_churn_reasons_m3",
        "config": {"mapping": {"columns": ["reason", "count"]}},
        "position": {"x": 0, "y": 125, "w": 1, "h": 1},
        "sort_order": 299.77,
    },
    {
        "chart_key": "op_select_churn_m3_accounts",
        "tab_key": "operations",
        "title": "Operations · accounts con caídas churn M3 (filtro)",
        "type": "table",
        "dataset_key": "op_churn_m3_accounts",
        "config": {"mapping": {"columns": ["value", "label", "count"]}},
        "position": {"x": 0, "y": 125, "w": 1, "h": 1},
        "sort_order": 299.78,
    },
    {
        "chart_key": "op_select_churn_m3_recruiters",
        "tab_key": "operations",
        "title": "Operations · recruiters con caídas churn M3 (filtro)",
        "type": "table",
        "dataset_key": "op_churn_recruiters",
        "config": {"mapping": {"columns": ["value", "label", "count"]}},
        "position": {"x": 0, "y": 125, "w": 1, "h": 1},
        "sort_order": 299.79,
    },
    {
        "chart_key": "op_donut_close_lost_reasons",
        "tab_key": "operations",
        "title": "Operations · Razones de Close Lost de opps",
        "type": "donut",
        "dataset_key": "op_close_lost_reasons",
        "config": {"mapping": {"x": "reason", "y": ["count"], "formatter": "number"}},
        "position": {"x": 0, "y": 119, "w": 6, "h": 6},
        "sort_order": 299.72,
    },
    {
        "chart_key": "op_table_close_lost_reasons_detail",
        "tab_key": "operations",
        "title": "Operations · detalle Close Lost por razón",
        "type": "table",
        "dataset_key": "op_close_lost_reasons_detail",
        "config": {"mapping": {"columns": ["reason", "client_name", "opp_position_name", "close_date", "owner"]}},
        "position": {"x": 6, "y": 119, "w": 6, "h": 6},
        "sort_order": 299.74,
    },
    {
        "chart_key": "op_select_close_lost_accounts",
        "tab_key": "operations",
        "title": "Operations · accounts con Close Lost (filtro)",
        "type": "table",
        "dataset_key": "op_close_lost_accounts",
        "config": {"mapping": {"columns": ["value", "label", "count"]}},
        "position": {"x": 0, "y": 119, "w": 1, "h": 1},
        "sort_order": 299.62,
    },
    {
        "chart_key": "op_select_close_lost_reasons",
        "tab_key": "operations",
        "title": "Operations · razones de Close Lost (filtro)",
        "type": "table",
        "dataset_key": "op_close_lost_reasons",
        "config": {"mapping": {"columns": ["reason", "count"]}},
        "position": {"x": 0, "y": 119, "w": 1, "h": 1},
    ...
    {
        "chart_key": "op_select_close_lost_recruiters",
        "tab_key": "operations",
        "title": "Operations · recruiters con Close Lost (filtro)",
        "type": "table",
        "dataset_key": "op_close_lost_recruiters",
        "config": {"mapping": {"columns": ["value", "label", "count"]}},
        "position": {"x": 0, "y": 119, "w": 1, "h": 1},
        "sort_order": 299.64,
    },
    ...
    {
        "chart_key": "op_select_rejection_recruiters",
        "tab_key": "operations",
        "title": "Operations · recruiters con rechazos (filtro)",
        "type": "table",
        "dataset_key": "op_rejection_recruiters",
        "config": {"mapping": {"columns": ["value", "label", "count"]}},
        "position": {"x": 0, "y": 120, "w": 1, "h": 1},
        "sort_order": 299.85,
    },
    {
        "chart_key": "op_select_churn_recruiters",
        "tab_key": "operations",
        "title": "Operations · recruiters con caídas (filtro)",
        "type": "table",
        "dataset_key": "op_churn_recruiters",
        "config": {"mapping": {"columns": ["value", "label", "count"]}},
        "position": {"x": 0, "y": 113, "w": 1, "h": 1},
        "sort_order": 299.65,
    },
    {
        "chart_key": "op_select_rejection_accounts",
        "tab_key": "operations",
        "title": "Operations · accounts con rechazos (filtro)",
        "type": "table",
        "dataset_key": "op_rejection_accounts",
        "config": {"mapping": {"columns": ["value", "label", "count"]}},
        "position": {"x": 0, "y": 120, "w": 1, "h": 1},
        "sort_order": 299.86,
    },
    {
        "chart_key": "op_select_churn_accounts",
        "tab_key": "operations",
        "title": "Operations · accounts con caídas (filtro)",
        "type": "table",
        "dataset_key": "op_churn_accounts",
        "config": {"mapping": {"columns": ["value", "label", "count"]}},
        "position": {"x": 0, "y": 113, "w": 1, "h": 1},
        "sort_order": 299.66,
    },
    {
        "chart_key": "op_select_rejection_reasons",
        "tab_key": "operations",
        "title": "Operations · razones de rechazo (filtro)",
        "type": "table",
        "dataset_key": "op_rejection_reasons",
        "config": {"mapping": {"columns": ["reason", "count"]}},
        "position": {"x": 0, "y": 120, "w": 1, "h": 1},
    ...
    {
        "chart_key": "op_select_churn_reasons",
        "tab_key": "operations",
        "title": "Operations · razones de caída (filtro)",
        "type": "table",
        "dataset_key": "op_churn_reasons",
        "config": {"mapping": {"columns": ["reason", "count"]}},
        "position": {"x": 0, "y": 113, "w": 1, "h": 1},
    ...
    {
        "chart_key": "op_kpi_one_shot_kill",
        "tab_key": "operations",
        "title": "Operations · One shot one kill (KPI)",
        "type": "kpi",
        "dataset_key": "op_one_shot_kill_summary",
        "config": {"mapping": {"value": "conversion_pct", "label": "%", "formatter": "percent"}},
        "position": {"x": 0, "y": 126, "w": 4, "h": 5},
        "sort_order": 300.1,
    },
    {
        "chart_key": "op_table_one_shot_kill_by_recruiter",
        "tab_key": "operations",
        "title": "Operations · One shot one kill por recruiter",
        "type": "table",
        "dataset_key": "op_one_shot_kill_by_recruiter",
        "config": {"mapping": {"columns": ["recruiter", "placements", "one_shot_count", "conversion_pct"]}},
        "position": {"x": 4, "y": 126, "w": 8, "h": 5},
        "sort_order": 300.2,
    },
    {
        "chart_key": "op_line_one_shot_kill",
        "tab_key": "operations",
        "title": "One shot one kill · monthly",
        "type": "line",
        "dataset_key": "op_one_shot_kill_history",
        "config": {
            "mapping": {
                "x": "mes",
                "y": ["conversion_pct"],
                "formatter": "percent",
                "tooltipExtras": ["one_shot_count", "placements"],
            },
        },
        "position": {"x": 0, "y": 131, "w": 12, "h": 5},
        "sort_order": 300.25,
    },
    {
        "chart_key": "op_table_one_shot_kill_detail",
        "tab_key": "operations",
        "title": "Operations · One shot one kill — detalle",
        "type": "table",
        "dataset_key": "op_one_shot_kill_detail",
        "config": {"mapping": {"columns": ["hire_date", "opp_position_name", "client_name", "recruiter", "candidate_name", "batch_num", "one_shot"]}},
        "position": {"x": 0, "y": 131, "w": 12, "h": 6},
        "sort_order": 300.3,
    },
    {
