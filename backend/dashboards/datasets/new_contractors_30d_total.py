...
def query(filters: dict, *_args, **_kwargs) -> tuple[str, dict]:
    ...
    sql = """
        ...
        SELECT
          COUNT(*)::int AS new_contractors_30d
        FROM first_hire fh
...
DATASET = {
    "key": "new_contractors_30d_total",
    "label": "New Contractors — 30d Rolling Total (Staffing)",
    "dimensions": [],
    "measures": [
        {"key": "new_contractors_30d", "label": "Nuevos contractors (30d)", "type": "number"},
    ],
    "default_filters": {},
    "query": query,
}
