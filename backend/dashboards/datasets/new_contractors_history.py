...
DATASET = {
    "key": "new_contractors_history",
    "label": "New Contractors per Month (Staffing)",
    "dimensions": [
        {"key": "mes", "label": "Mes", "type": "date"},
    ],
    "measures": [
        {"key": "new_contractors", "label": "Nuevos contractors", "type": "number"},
    ],
    "default_filters": {},
    "query": query,
}
