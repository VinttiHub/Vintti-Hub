...
def query(filters: dict, *_args, **_kwargs) -> tuple[str, dict]:
    ...
    mes = (
        _parse_date(filters.get("mes_nda_close_win"))
        or _parse_date(filters.get("Month_NDA"))
    ...
    sql = """
        ...
        WHERE DATE_TRUNC('month', cu.close_d)::date = mo.mes_pick
...
DATASET = {
    "key": "nda_close_win_month_detail",
    "label": "All NDA a close win — detalle por mes",
    "dimensions": [
