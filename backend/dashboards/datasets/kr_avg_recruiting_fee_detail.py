"""KR4 detalle · fee Recruiting por candidato colocado (AM+AE, últimos 30 días)."""
...
DATASET = {
    "key": "kr_avg_recruiting_fee_detail",
    "label": "KR4 detalle · fee Recruiting por candidato (AM+AE, 30d)",
    "dimensions": [
