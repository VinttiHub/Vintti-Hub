"""KR4 · Avg Recruiting Fee por candidato colocado ($) — AM + AE, últimos 30 días.

Fee promedio de Vintti (placement revenue `ho.revenue`) por CANDIDATO colocado
en deals Recruiting Close Win cuyo `opp_close_date` cae en los últimos 30 días.
Scope AM + AE (unión opp_sales_lead ∈ {AEs} OR account_manager = {AM}).
avg = Σ revenue / nº de candidatos colocados (hires con candidate_id).
"""
...
DATASET = {
    "key": "kr_avg_recruiting_fee",
    "label": "KR4 · Avg Recruiting Fee / candidato (AM+AE, 30d)",
    "dimensions": [],
    "measures": [
