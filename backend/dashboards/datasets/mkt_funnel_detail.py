...
from .mkt_funnel_mql_sql_cw import _WON, _REACHED_SQL, _REACHED_MQL, _IN_VALUES, _EXCLUDE
...
def compute(filters: dict, *_args, **_kwargs) -> list[dict]:
    ...
    contacts = client.search_contacts(
        ...
        extra_properties=[lead_life_property, anchor, origin_prop, company_prop],
    )
