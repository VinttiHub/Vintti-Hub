...
from . import (
    ...
    op_churn_reasons_m3,
    op_churn_reasons_m3_detail,
    op_churn_m3_accounts,
    op_close_lost_reasons,
    op_close_lost_reasons_detail,
    op_close_lost_accounts,
    op_close_lost_recruiters,
    ...
    sql_to_ndasigned_30d,
    sql_to_ndasigned_30d_steps,
    nda_to_clientwin_30d,
    nda_to_clientwin_30d_detail,
    nda_closewin_opp_30d,
    nda_closewin_opp_30d_detail,
    ...
    reactivated_clients_30d_total,
    reactivated_clients_30d_detail,
    ...
    position_lifetime_summary,
    position_lifetime_detail,
    ...
    op_client_process_blocked_detail,
    interviewed_sent_30d_summary,
    turbo_closewin_30d_summary,
    turbo_closewin_history,
    turbo_closewin_detail,
    turbo_with_candidates_30d_summary,
    turbo_with_candidates_history,
    turbo_with_candidates_detail,
    turbo_avg_candidates_30d_summary,
    turbo_avg_candidates_history,
    turbo_avg_candidates_detail,
    turbo_detail_full,
    ...
    mkt_mqls_sqls_by_origin,
    mkt_mqls_business_metric,
    mkt_leads_by_channel_history,
    mkt_funnel_mql_sql_cw,
    mkt_funnel_detail,
...
_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    am_nrr_history.DATASET["key"]: am_nrr_history.DATASET,
    am_nrr_month_detail.DATASET["key"]: am_nrr_month_detail.DATASET,
    am_nrr_30d_summary.DATASET["key"]: am_nrr_30d_summary.DATASET,
    am_nrr_30d_detail.DATASET["key"]: am_nrr_30d_detail.DATASET,
    ...
    sql_to_ndasigned_30d.DATASET["key"]: sql_to_ndasigned_30d.DATASET,
    sql_to_ndasigned_30d_steps.DATASET["key"]: sql_to_ndasigned_30d_steps.DATASET,
    ...
    nda_closewin_opp_30d.DATASET["key"]: nda_closewin_opp_30d.DATASET,
    nda_closewin_opp_30d_detail.DATASET["key"]: nda_closewin_opp_30d_detail.DATASET,
    ...
    reactivated_clients_30d_total.DATASET["key"]: reactivated_clients_30d_total.DATASET,
    reactivated_clients_30d_detail.DATASET["key"]: reactivated_clients_30d_detail.DATASET,
    ...
    position_lifetime_summary.DATASET["key"]: position_lifetime_summary.DATASET,
    position_lifetime_detail.DATASET["key"]: position_lifetime_detail.DATASET,
    ...
    op_client_process_blocked_detail.DATASET["key"]: op_client_process_blocked_detail.DATASET,
    interviewed_sent_30d_summary.DATASET["key"]: interviewed_sent_30d_summary.DATASET,
    turbo_closewin_30d_summary.DATASET["key"]: turbo_closewin_30d_summary.DATASET,
    turbo_closewin_history.DATASET["key"]: turbo_closewin_history.DATASET,
    turbo_closewin_detail.DATASET["key"]: turbo_closewin_detail.DATASET,
    turbo_with_candidates_30d_summary.DATASET["key"]: turbo_with_candidates_30d_summary.DATASET,
    turbo_with_candidates_history.DATASET["key"]: turbo_with_candidates_history.DATASET,
    turbo_with_candidates_detail.DATASET["key"]: turbo_with_candidates_detail.DATASET,
    turbo_avg_candidates_30d_summary.DATASET["key"]: turbo_avg_candidates_30d_summary.DATASET,
    turbo_avg_candidates_history.DATASET["key"]: turbo_avg_candidates_history.DATASET,
    turbo_avg_candidates_detail.DATASET["key"]: turbo_avg_candidates_detail.DATASET,
    turbo_detail_full.DATASET["key"]: turbo_detail_full.DATASET,
    ...
    buyouts_window_detail.DATASET["key"]: buyouts_window_detail.DATASET,
    ...
    mkt_mqls_sqls_by_origin.DATASET["key"]: mkt_mqls_sqls_by_origin.DATASET,
    mkt_mqls_business_metric.DATASET["key"]: mkt_mqls_business_metric.DATASET,
    mkt_leads_by_channel_history.DATASET["key"]: mkt_leads_by_channel_history.DATASET,
    mkt_funnel_mql_sql_cw.DATASET["key"]: mkt_funnel_mql_sql_cw.DATASET,
    mkt_funnel_detail.DATASET["key"]: mkt_funnel_detail.DATASET,
    ...
    op_churn_reasons_m3.DATASET["key"]: op_churn_reasons_m3.DATASET,
    op_churn_reasons_m3_detail.DATASET["key"]: op_churn_reasons_m3_detail.DATASET,
    op_churn_m3_accounts.DATASET["key"]: op_churn_m3_accounts.DATASET,
    op_close_lost_reasons.DATASET["key"]: op_close_lost_reasons.DATASET,
    op_close_lost_reasons_detail.DATASET["key"]: op_close_lost_reasons_detail.DATASET,
    op_close_lost_accounts.DATASET["key"]: op_close_lost_accounts.DATASET,
    op_close_lost_recruiters.DATASET["key"]: op_close_lost_recruiters.DATASET,
