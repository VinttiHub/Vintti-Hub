...
Promedio del fee (placement revenue) cobrado en deals Recruiting `Close Win`
de Mariano + Bahia cuya `opp_close_date` cae en los últimos 30 días.

Un "deal" = una opportunity. Si una opp tiene N hires, se suman primero por opp
y después se promedia entre opps — así Theta (2 hires) cuenta como 1 deal.
"""
...
DATASET = {
    "key": "avg_recruiting_fee_30d",
    "label": "Avg Recruiting Fee — últimos 30 días (M+B)",
    "dimensions": [
        {"key": "win_ini", "label": "Inicio ventana", "type": "date"},
        {"key": "win_fin", "label": "Corte", "type": "date"},
    ],
    "measures": [
        {"key": "avg_fee", "label": "Avg fee por deal", "type": "currency"},
        {"key": "total_fee", "label": "Total fee (window)", "type": "currency"},
